...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    actor_rollout_ref.actor.use_entropy_loss_masking=${use_entropy_loss_masking:-False} \
    actor_rollout_ref.actor.entropy_mask_threshold=${entropy_mask_threshold:-0.0} \
